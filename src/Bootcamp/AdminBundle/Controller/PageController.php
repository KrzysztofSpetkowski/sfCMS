...
use Bootcamp\AdminBundle\Entity\Page;
use Bootcamp\AdminBundle\Form\PageType;
use Bootcamp\AdminBundle\Form\PageFilterType;
...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('BootcampAdminBundle:Page:index.html.twig', array(
            'entities' => $entities,
            'pagerHtml' => $pagerHtml,
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('BootcampAdminBundle:Page')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BootcampAdminBundle:Page')->find($id);
        ...
        return $this->render('BootcampAdminBundle:Page:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BootcampAdminBundle:Page:edit.html.twig', array(
            'entity'      => $entity,
